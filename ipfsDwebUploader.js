...
const useDAppNode = true;

// const ipfsProvider = "my.ipfs.dnp.dappnode.eth";
const ipfsGateway = useDAppNode
  ? "http://my.ipfs.dnp.dappnode.eth:8080"
  : "https://ipfs.io";
const ipfsProvider = useDAppNode
  ? {
...
const ipfs = new IpfsAPI(ipfsProvider);

const args = process.argv.slice(2);
const path = args[0];

console.log("Uploading files...");
ipfs.addFromFs(path, { recursive: true }).then(response => {
